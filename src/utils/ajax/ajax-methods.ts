...
import type {AjaxBaseConfig} from './ajax-base';
 ...
 */
export function ajaxDelete<TResponseData, TError = unknown>(
 ...
 * @returns Extended Promise with XHR request.
 */
export function ajaxGet<TResponseData, TError = unknown>(
...
export type AjaxPatchConfig<TRequestData, TResponseData, TError = unknown> = Omit<
 ...
 * @returns Extended Promise with XHR request.
 */
export function ajaxPatch<TRequestData, TResponseData, TError = unknown>(
...
export type AjaxPostConfig<TRequestData, TResponseData, TError = unknown> = Omit<
	AjaxBaseConfig<TRequestData, TResponseData, TError>,
	'method' | 'query' | 'upload'
>;
 ...
 * @returns Extended Promise with XHR request.
 */
export function ajaxPost<TRequestData, TResponseData, TError = unknown>(
 ...
 * @returns Extended Promise with XHR request.
 */
export function ajaxPut<TRequestData, TResponseData, TError = unknown>(
 ...
 * @returns Extended Promise with XHR request.
 */
export function ajaxUpload<TResponseData, TError = unknown>(
